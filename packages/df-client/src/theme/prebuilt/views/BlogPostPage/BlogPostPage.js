...
import blogPostPageStyle from '@sxs/theme/img/jss/material-kit-pro-react/views/blogPostPageStyle.js';
...
export default function BlogPostPage() {
  ...
  return (
    <div>
      ...
      />
      <Parallax image={require('@sxs/theme/img/img/bg5.jpg')} filter="dark">
