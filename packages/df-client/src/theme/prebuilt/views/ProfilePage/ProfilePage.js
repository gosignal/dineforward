...
import oluEletu from '@sxs/theme/img/img/examples/olu-eletu.jpg';
import clemOnojeghuo from '@sxs/theme/img/img/examples/clem-onojeghuo.jpg';
import cynthiaDelRio from '@sxs/theme/img/img/examples/cynthia-del-rio.jpg';
import mariyaGeorgieva from '@sxs/theme/img/img/examples/mariya-georgieva.jpg';
import clemOnojegaw from '@sxs/theme/img/img/examples/clem-onojegaw.jpg';
import darrenColeshill from '@sxs/theme/img/img/examples/darren-coleshill.jpg';
...
import profilePageStyle from '@sxs/theme/img/jss/material-kit-pro-react/views/profilePageStyle.js';
...
export default function ProfilePage({ ...rest }) {
  ...
  return (
    <div>
      ...
      />
      <Parallax
        image={require('@sxs/theme/img/img/examples/city.jpg')}
        filter="dark"
