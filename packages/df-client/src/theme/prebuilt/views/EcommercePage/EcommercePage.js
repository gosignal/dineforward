...
import SectionLatestOffers from '@sxs/views/EcommercePage/Sections/SectionLatestOffers.js';
import SectionProducts from '@sxs/views/EcommercePage/Sections/SectionProducts.js';
import SectionBlog from '@sxs/views/EcommercePage/Sections/SectionBlog.js';
...
import ecommerceHeader from '@sxs/theme/img/img/examples/ecommerce-header.jpg';
import face1 from '@sxs/theme/img/img/faces/card-profile6-square.jpg';
import face2 from '@sxs/theme/img/img/faces/christian.jpg';
import face3 from '@sxs/theme/img/img/faces/card-profile4-square.jpg';
import face4 from '@sxs/theme/img/img/faces/card-profile1-square.jpg';
import face5 from '@sxs/theme/img/img/faces/marc.jpg';
import face6 from '@sxs/theme/img/img/faces/kendall.jpg';
import face7 from '@sxs/theme/img/img/faces/card-profile5-square.jpg';
import face8 from '@sxs/theme/img/img/faces/card-profile2-square.jpg';

import styles from '@sxs/theme/img/jss/material-kit-pro-react/views/ecommerceStyle.js';
...
export default function EcommercePage() {
  ...
  return (
    <div>
      ...
      />
      <Parallax
        image={require('@sxs/theme/img/img/examples/clark-street-merc.jpg')}
        filter="dark"
        small
      >
