...
import productStyle from '@sxs/theme/img/jss/material-kit-pro-react/views/productStyle.js';

// images
import cardProduct1 from '@sxs/theme/img/img/examples/card-product1.jpg';
import cardProduct3 from '@sxs/theme/img/img/examples/card-product3.jpg';
import cardProduct4 from '@sxs/theme/img/img/examples/card-product4.jpg';
import cardProduct2 from '@sxs/theme/img/img/examples/card-product2.jpg';
import product1 from '@sxs/theme/img/img/examples/product1.jpg';
import product2 from '@sxs/theme/img/img/examples/product2.jpg';
import product3 from '@sxs/theme/img/img/examples/product3.jpg';
import product4 from '@sxs/theme/img/img/examples/product4.jpg';
...
export default function ProductPage() {
  ...
  return (
    <div className={classes.productPage}>
      ...
      />
      <Parallax
        image={require('@sxs/theme/img/img/bg6.jpg')}
        filter="rose"
