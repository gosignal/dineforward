...
import landingPageStyle from '@sxs/theme/img/jss/material-kit-pro-react/views/landingPageStyle.js';
  ...
  return (
    <div>
      <Header
        ...
        {...rest}
      />
      <Parallax image={require('@sxs/theme/img/img/bg8.jpg')} filter="dark">
