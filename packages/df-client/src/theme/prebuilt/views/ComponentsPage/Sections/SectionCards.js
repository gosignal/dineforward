...
import styles from '@sxs/theme/img/jss/material-kit-pro-react/views/componentsSections/sectionCards.js';

import cardBlog1 from '@sxs/theme/img/img/examples/card-blog1.jpg';
import cardBlog2 from '@sxs/theme/img/img/examples/card-blog2.jpg';
import cardBlog3 from '@sxs/theme/img/img/examples/card-blog3.jpg';
import cardBlog5 from '@sxs/theme/img/img/examples/card-blog5.jpg';
import cardBlog6 from '@sxs/theme/img/img/examples/card-blog6.jpg';
import cardProfile1 from '@sxs/theme/img/img/examples/card-profile1.jpg';
import cardProfile4 from '@sxs/theme/img/img/examples/card-profile4.jpg';
import blog1 from '@sxs/theme/img/img/examples/blog1.jpg';
import blog5 from '@sxs/theme/img/img/examples/blog5.jpg';
import blog6 from '@sxs/theme/img/img/examples/blog6.jpg';
import blog8 from '@sxs/theme/img/img/examples/blog8.jpg';
import avatar from '@sxs/theme/img/img/faces/avatar.jpg';
import christian from '@sxs/theme/img/img/faces/christian.jpg';
import marc from '@sxs/theme/img/img/faces/marc.jpg';
import office1 from '@sxs/theme/img/img/examples/office1.jpg';
import color1 from '@sxs/theme/img/img/examples/color1.jpg';
import color2 from '@sxs/theme/img/img/examples/color2.jpg';
import color3 from '@sxs/theme/img/img/examples/color3.jpg';
            ...
            <GridItem xs={12} sm={7} md={7}>
              <div className={classes.title}>
                ...
                <h4>
                  ...
                  color shadow. You don't have to do anything to activate them,
                  just enjoy the new look of your website.
                </h4>
                <br />
              </div>
            </GridItem>
