...
// import googleLogo from './google-logo-on-white-bg.png';
// const googleLogo = require('./google-logo-on-white-bg.png');
const googleLogo = () => <img src="./google-logo-on-white-bg.png" alt="" />;
...
// rendered
const renderSuggestionsContainer = (suggestions, downshiftRenderProps) => {
  ...
  const renderedSuggestions = renderSuggestions(
...
// suggestions.
const renderSuggestions = (suggestions, { getItemProps, inputValue, highlightedIndex }) => {
...
const renderSuggestion = (suggestion, { getItemProps, inputValue, isHighlighted }) => {
...
const MUIPlacesAutocomplete = props => {
  ...
  }, [setGoogleReady, autocompleteService]);
  ...
  const onInputValueChange = inputValue => {
    ...
    const { createAutocompleteRequest } = props;
  ...
  const renderAutocomplete = ({
    ...
    const { renderTarget, textFieldProps } = props;
    ...
    return (
      <div>
        <Manager tag={false}>
          ...
          />
          <Reference>{renderTarget()}</Reference>
          {isOpen
  ...
  const controlProps =
    props.textFieldProps && props.textFieldProps.value
