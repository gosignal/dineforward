...
/**
 * The PageTransition component *always* passes a prop to it's children
 * to support a callback. But ThemeProvider checks its props at runtime
 * and gives an error on the extraneous prop.
 * This component simply doesn't pass its props along 
 */
