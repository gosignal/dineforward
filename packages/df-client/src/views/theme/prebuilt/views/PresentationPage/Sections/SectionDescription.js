...
import descriptionStyle from '@sxs/theme/img/jss/material-kit-pro-react/views/presentationSections/descriptionStyle.js';
        ...
        <GridContainer justify="center">
          <GridItem md={8} sm={8}>
            <h4 className={classes.description}>
              ...
              design inspired by Google's Material Design. You asked for it, so
              we built it. It's a great pleasure to introduce to you the
