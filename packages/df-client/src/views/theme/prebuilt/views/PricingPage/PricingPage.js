...
import SectionPricing from '@sxs/views/PricingPage/Sections/SectionPricing.js';
import SectionFeatures from '@sxs/views/PricingPage/Sections/SectionFeatures.js';

import pricingStyle from '@sxs/theme/img/jss/material-kit-pro-react/views/pricingStyle.js';
...
export default function PricingPage() {
  ...
  return (
    <div>
      ...
      <Parallax
        image={require('@sxs/theme/img/img/bg2.jpg')}
        filter="dark"
        small
      >
